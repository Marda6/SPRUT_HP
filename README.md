...
Внутри «Библиотеки» два раздела: «Проекты» и «Цифровое оборудование».
Разделы «Недавние», «Локальные», «Расширения», «Менеджер лицензий» в навигации есть,
но страницы пока не собраны — кнопки не ведут никуда.

Полное состояние работы, принятые решения, отступления от макета и грабли —
в [HANDOFF.md](HANDOFF.md). С него стоит начинать в новой сессии.
